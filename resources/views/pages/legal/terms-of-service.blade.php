    ...
    <div class="container py-3">
        <div class="row h-10 align-items-sm-center justify-content-center ">
            <div class="col-12 col-sm-9 col-md-7 col-lg-10 col-xl-14">
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title justify-content-center d-flex ">
                            Algemene voorwaarden en privacybeleid
                        </h3>
                        <p>Bing Chilling, gevestigd aan test, is verantwoordelijk voor de verwerking van persoonsgegevens
                            zoals weergegeven in deze privacyverklaring. Contactgegevens: https://www.testtesttest1234321.nl
                            test 0612874650 </p>
                        <h5>Persoonsgegevens die wij verwerken</h5>
                        <p>Bing Chilling verwerkt uw persoonsgegevens doordat u gebruik maakt van onze diensten en/of omdat
                        ...
                        <p>
                            ...
                            ons op via testtest55667754@gmail.com, dan verwijderen wij deze informatie.
                        </p>
                        ...
                        <p>
                            Bing Chilling neemt #responsibility op basis van geautomatiseerde verwerkingen besluiten over
                            zaken die (aanzienlijke) gevolgen kunnen hebben voor personen. Het gaat hier om besluiten die
                            worden genomen door computerprogramma's of -systemen, zonder dat daar een mens (bijvoorbeeld een
                            medewerker van Bing Chilling) tussen zit. Bing Chilling gebruikt de volgende computerprogramma's
                            of -systemen:
                        <ul>
                        ...
                        <p>
                            Bing Chilling bewaart uw persoonsgegevens niet langer dan strikt nodig is om de doelen te
                            realiseren waarvoor uw gegevens worden verzameld. Wij hanteren de volgende bewaartermijnen voor
                        ...
                        <p>
                            Bing Chilling verstrekt uitsluitend aan derden en alleen als dit nodig is voor de uitvoering van
                        ...
                        <p>
                            Bing Chilling gebruikt alleen technische en functionele cookies. En analytische cookies die geen
                        ...
                        <p>
                            ...
                            Burgerservicenummer (BSN) zwart. Dit ter bescherming van uw privacy. Bing Chilling zal zo snel
                            mogelijk, maar in ieder geval binnen vier weken, op uw verzoek reageren.
                            Bing Chilling wil u er tevens op wijzen dat u de mogelijkheid hebt om een klacht in te dienen
                        ...
                        <p>
                            Bing Chilling neemt de bescherming van uw gegevens serieus en neemt passende maatregelen om
                            misbruik, verlies, onbevoegde toegang, ongewenste openbaarmaking en ongeoorloofde wijziging
                            tegen te gaan. Als u de indruk heeft dat uw gegevens niet goed beveiligd zijn of er aanwijzingen
                            zijn van misbruik, neem dan contact op met onze klantenservice of via testtest55667754@gmail.com
                        </p>
                    </div>
                </div>
            </div>
